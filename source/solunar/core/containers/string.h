...
namespace solunar
{
	...
	class hybrid_string
	{
		...
		static_assert(ElementCount == 0 ? IsRealocatable : true, "if you specified ElementCount as 0 it means that it doesn't use stack memory at all and it means that container is forced to support reallocation!");
